...
public class TestPrepImpact {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 2) {
            System.err.println("Usage: TestPrepImpact <input> <output>");
            System.exit(2);
        }
        ...
        Job job = Job.getInstance(conf, "test prep impact");
        job.setJarByClass(TestPrepImpact.class);
